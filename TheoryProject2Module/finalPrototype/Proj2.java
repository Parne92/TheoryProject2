...
public class Proj2 {
    ...
    public static void main(String[] args) {
        RegularExpression re = new RegularExpression("(10U00)*");
        System.out.println(re.test("00")); // True.
        System.out.println(re.test("100010"));  // True.
        System.out.println(re.test("00100"));  // False.
        System.out.println(re.test(""));  // False.
